...
/**
 * Die Klasse <code>Rotation</code> beschreibt eine Rotation, also eine Drehung, diese ist durch
 * zwei Eigenschaften definiert:<br /> 1. Der Winkel, um den gedreht wird<br /> 2. Der Punkt, um den
 * gedreht<br /> <br /> <b>Ein Anwendungsbeispiel:</b><br /><br /> <code> //Baustelle: wird
 * vervollstaendigt, wenn Rotationen vollstaendig in Raum implementiert sind </code>
 *
...
public class Rotation {
	 ...
	 *
	 * @param winkelInGrad
	 * 		Der Winkel, um den gedreht werden soll <b>im Gradmass</b>.
	 * @param zentrum
