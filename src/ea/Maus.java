...
public class Maus {
	...
	/**
	 * Voller Konstruktor fÃ¼r eine Standard-Maus.<br />
	 * Hierbei gibt es ganz verschiedene Maeuse, die ueber ihren Index gewÃ¤hlt werden kÃ¶nnen. Hierzu ist das <i>Handbuch</i> zu
	 * konsultieren.
	 * 
	 * @param mausArt
	 ...
	 * 
	 * @param von
	 *            Von dieser Maus, werden alle Listener-Listen Ã¼bernommen.
	 *            Bereits vorhandene Listener bleiben dabei erhalten, werden aber
	 *            eventuell <b>DOPPELT</b> eingefÃ¼gt.
	 */
