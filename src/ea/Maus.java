...
public class Maus {
	...
	/**
	 * Unabhängiger Konstruktor. Dieser Konstruktor ermöglicht es, ein eigenes Mausbild einzubringen.<br />
	 ...
	 * Dieser Punkt gibt an, welcher Punkt exakt der "Klickpunkt" ist.<br />
	 * <br />
	 * 
	 ...
	 * @param absolut
	 *            Ob diese Maus absolut sein soll; ist dieser Wert <code>true</c>, so ist die Maus immer in der Mitte, dafuer bewegt sich 
	 ...
	 * @param bewegend
	 *            Ist dieser Wert <code>true</code>, so wird die Maus, wenn sie sich aus dem Fenster bewegt (bei einer absoluten Maus bei
	...
	/**
	 * Voller Konstruktor für eine Standard-Maus.<br />
	 * Hierbei gibt es ganz verschiedene Maeuse, die ueber ihren Index gewählt werden können. Hierzu ist das <i>Handbuch</i> zu
	 * konsultieren.
	 * 
	 * @param mausArt
	 *            Die Art der Maus. Jeder Wert steht fuer eine eigene Maus.
	 * @param absolut
	 *            Ob die Maus absolut (immer in der Mitte) oder relativ (auf dem Bildschirm frei beweglich) sein soll.
	 * @param bewegend
	 ...
	 * @param code
	 *            Der Code, mit dem ein Klick auf dieses Objekt assoziiert wird.<br />
	 *            Diese Zahl wird als Argument bei der Reaktionsmethode mitgegeben, wodurch, bei korrekten Programmierorganisation dieser Zahlen, eine sehr gute Unterscheidung ohne groesseren
	...
	/**
	 * Meldet ein <code>MausLosgelassenReagierbar</code>-Objekt bei der Maus an. <br />
	 ...
	 * 
	 * @param von
	 *            Von dieser Maus, werden alle Listener-Listen übernommen.
