...
implements Ticker
{
     ...
     * @param   intervall   Der TickerIntervall; fuer die tick()-Geschwindikeit.
     * @param   loop    Ob die Animation dauerhaft wiederholt (geloopt) werden soll.
     * @param   m   Der Manager, an dem spaeter animiert werden soll.
     ...
     * angehalten wird.<br />
     * In ihr sollte <b>hoechstens einmal</b> das Ziel-Objekt bewegt werden! Ansonsten wird die Interaktion mit der Klasse 
     * <code>Physik</code> und damit das moegliche Einrechnen fuer die Objekte nicht moeglich.
     * @see tick()
     * @see beenden()
     * @see anhalten()
     */
