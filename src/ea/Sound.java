 ...
 * Diese kann unterschiedlichen Typs sein. Bis jetzt werden folgende Formate unterstuetzt:<br />
 * <br />
 * -MIDI-Format (.midi-Dateien): Musikalisches Notenpapier fuer einen MIDI-Synthesizer<br />
 * -WAVE-Sounds (.wav-Dateien): Gesampleter Sound.<br />
 * <br />
 ...
 * abgespielt werden soll, da laengere Wartezeiten zwischen Ende des Loops und anfangs des neuen bestehen.</b>.<br />
 * <br />
 * <br />
 * 
...
public class Sound
{
	 ...
	 * 
	 * @param verzeichnis
	 *            Das Verzeichnis der Sound-Datei. Mit Endung angeben! (z.B. "meinSound.wav")
	 * @param tempoBPM
	 *            Das Abspieltempo in Beats per Minute; nur fuer MIDI-Dateien relevant.
	 */
