...
/**
 * Der Client fuer nicht vorhandene Teilnahme an der Physik.<br /> Standartmaessig der
 * Initialclient.
 *
...
public class NullClient extends PhysikClient {
	 ...
	 *
	 * @return Immer <code>true</code>, da die Bewegung eines physikalisch neutralen Objektes immer
	 * in vollem Zuge moeglich ist!
	 */
	@Override
	 ...
	 * Fehlermeldung ausgegeben. Denn es wurde ein nichtaktives Objekt zum Sprung gebracht.
	 *
	 * @param kraft
	 ...
	 * Neutral-Objekt keinen Sinn.<br /> Daher wird nur eine Fehlermeldung ausgegeben.
	 *
	 * @param aktiv
	 ...
	 * Fehlermeldung ausgegeben, da bei dieser Klasse ein neutrales Objekt vorliegt, das keine
	...
	/**
	 * Setzt die Schwerkraft fuer dieses Objekt.<br /> Da dies jedoch bei einem neutralen Objekt
