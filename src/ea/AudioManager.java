...
public class AudioManager extends Manager {
	 ...
	 * 
	 * @param anzahlKanaele
	 *            Die anzahl an Kanaelen, die das AudioSystem hat.<br />
	 *            Jeder Kanal ist ein eigenstaendiger Thread, ist also
	 *            unabhaengig, jedoch Speicherlastig. Hier gilt es zu erwaegen,
	 *            wie viele Kanaele noetig sind, und wie viele das System
	 *            ueberlasten wuerden.
	 */
	...
	/**
	 * Spielt ein Sound-Objekt ab. Wenn alle Kanaele belegt sind, wird eine
	 * Fehlermeldung mit empfehlung zur Erhoehung der Kanalanzahl ausgegeben.<br />
	 * Egal ob der Sound auf Dauerschleife laeuft oder nicht, ueber
	 * <code>anhalten(meinSound)</code> kann er jederzeit wieder angehalten
	 * werden.
	 * 
	 * @param s
	 ...
	 * Dabei wird der Sound wieder zurueck zum Anfang gespult. Ist dies nicht
	 * gewuenscht, so bietet sich die Methode <code>pausieren(Sound s)</code>
	 * an. Wird der Sound momentan gar nicht abgespielt, passiert genau <b>gar
	 * nichts</b>.
	 * 
	 * @param s
	 ...
	 * Dabei wird der Sound nicht wieder zurueck zum Anfang gespult. Ist dies
	 * allerdings gewuenscht, so bietet sich die Methode
	 ...
	 * Das heisst, ueber diesen Manager wird kein Sound mehr laufen, bis ein
	 * neuer Clip wieder abgespielt wird.
	 */
