...
public class AudioManager extends Manager {
	 ...
	 * Egal ob der Sound auf Dauerschleife laeuft oder nicht, ueber <code>anhalten(meinSound)</code> kann er jederzeit wieder angehalten
	 * werden.
	 * 
	 * @param s
	 ...
	 * gewuenscht, so bietet sich die Methode <code>pausieren(Sound s)</code> an. Wird der Sound momentan gar nicht abgespielt, passiert genau <b>gar
	 * nichts</b>.
	 * 
	 * @param s
