 ...
 * Auf einem Kanal kann eine Sounddatei abgespielt werden.<br />
 * <br />
...
public class Kanal implements Ticker {
	/**
	 ...
	 * 
	 * @param m
	 *            Der Manager, an dem der Kanal anliegen soll
	 */
	 ...
	 * Zugrunde liegt der einfache Test mit dem Gleichheitsoperator '=='. Zurueckgegeben wird also einfach <code>(this.s == s)</code>.
	 * 
	 * @param s
	 *            Der Sound, auf den getestet werden soll, ob er gerade abgespielt wird.
	 ...
	 * 
	 * @param s
	 *            Der Sound, der die MP3-Datei wiederspiegelt.
	 */
