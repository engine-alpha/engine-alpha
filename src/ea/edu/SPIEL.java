 ...
 * entsprechend Ã¤ndern) an Schueler ausgegeben werden kann. Es startet alles 
...
public class SPIEL 
{
    ...
    public void tasteReagieren(int tastenkuerzel) {
        System.out.println("Taste mit Kürzel " + tastenkuerzel + 
                " wurde gedrückt");
    }
    
    //MIKE - weitere Wünschenswerte Methoden
    /**
     ...
     * @param hotspotX	Die X-Koordinate des Hotspots für das neue
     * 					Maus-Icon.
     * @param hotspotY	Die Y-Koordinate des Hotspots für das neue
     * 					Maus-Icon.
     */
