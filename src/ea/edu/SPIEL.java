...
public class SPIEL {
	 ...
	 *
	 * @param tastenkuerzel
	 * 		Der int-Wert, der fuer die gedrueckte Taste steht. Details koennen in der <i>Tabelle aller
	 ...
	 *
	 * @param ms
	 * 		Die Zeit in Millisekunden zwischen zwei Aufrufen der <code>tick()</code>-Methode.
	 */
	@API
	@SuppressWarnings ( "unused" )
	...
	/**
	 * Stoppt die Ticker-Funktion. Die <code>tick()</code>-Methode wird nicht weiter aufgerufen. Der
	 * automatische Aufruf der <code>tick()</code>-Methode kann durch die Methode
	 ...
	 * 		"mausicon.png"
	 * @param hotspotX
	 * 		Die X-Koordinate des Hotspots fuer das neue Maus-Icon. (relativ im Icon)
	 * @param hotspotY
	 * 		Die Y-Koordinate des Hotspots fuer das neue Maus-Icon. (relativ im Icon)
	 */
	@API
	@SuppressWarnings ( "unused" )
	...
	/**
	 * Setzt den linken Punktestand. Aenderungen sind nur sichtbar, wenn auch der linke Punktestand
	 * sichtbar ist.
	 *
	 * @param pl
	...
	/**
	 * Setzt den rechten Punktestand. Aenderungen sind nur sichtbar, wenn auch der rechte
	 * Punktestand sichtbar ist.
	 *
	 * @param pr
