...
public class AnzeigeE extends Manager implements Ticker, TastenReagierbar, KlickReagierbar, RechtsKlickReagierbar {
	 ...
	 * 
	 * @param visible
	 *            Bei <code>true</code> ist die Punkteanzeige sichtbar,
	 ...
	 * 
	 * @param o
	 *            Das anzumeldende Objekt, dessen Tickermethode aufgerufen werden soll.<br />
	...
	private final class KlickAuftrag {
		 ...
		 *            des Klicks.
		 * @param y
		 *            Die zu uebergebene Y-Koordinate
		 *            des Klicks.
		 */
