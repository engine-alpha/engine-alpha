...
/**
 * Diese Klasse der EDU-Version ermoeglicht das <b>extrem einfache, Schulunterrichtorientierte</b>
 * umsetzen des Unterrichtszieles "Minesweeper".<br /> Sie spiegelt eine echte
 * <code>Game</code>-Klasse wider.
 *
 * @author Andonie
 * @since 2.1
 */
public abstract class MineGameE {
	...
	/**
	 * Diese Methode wird beim Tastendruck aufgerufen.<br /> Sie wird an das <code>aim</code>-Objekt
	 * weitergeleitet.
	 *
	 * @param code
	...
	/**
	 * Diese Methode wird beim Linksklick aufgerufen.<br /> Sie wird an das <code>aim</code>-Objekt
	 * weitergeleitet.
	 *
	 * @param x
	...
	/**
	 * Diese Methode wird beim Rechtsklick aufgerufen.<br /> Sie wird an das <code>aim</code>-Objekt
	 * weitergeleitet.
	 *
	 * @param x
	 * 		Die X-Koordinate des Klicks.
