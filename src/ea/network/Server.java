...
/**
 * Server-Klasse f�r einfache Verwendung von Kommunikation.
 * @author Andonie
 *
 */
public class Server
...
implements Empfaenger, SenderInterface {
	...
	/**
	 * Die Queue, in der Verbindungen liegen, um vom API-Nutzer zus�tzlichen Empfaengern
	 ...
	 * dem API-Nutzer zug�nglichen Thread zu simulieren.<br /><br />
	...
	/**
	 * Der Server-Socket, �ber den die Streams gezogen werden.
	 */
	...
	/**
	 * Gibt die n�chste Verbindung mit diesem Server aus, die noch nicht 
	 * ausgegeben wurde. Gibt es keine Verbindung, die noch nicht ueber diese Methode
	 * ausgegeben wurde, so <b>h�lt der Thread solange an, bis eine neue Verbindung
	 * entstanden ist und diese zur�ckgegeben werden kann</b>.
	 * @return	Die �lteste, noch nicht �ber diese Methode zur�ckgegebene Verbindung.
	 * 			Diese Methode hat stets einen R�ckgabewert <code>!= null</code>. N�tigenfalls
	 * 			h�lt sie so lange wie n�tig den laufenden Thread an, bis eine Verbindung
	 * 			zur�ckgegeben werden kann.
	 */
	 ...
	 * Verbindung</i> bereits aufgel�st sein.
	...
	/**
	 * {@inheritDoc}
	 * Gibt die Nachricht an den globalen Empf�nger 
	 ...
	 * Es ist daher gut m�glich, dass der Server trotzdem noch 
