...
public class Anmelden {
    ...
    public void tastenReagierbar (TastenReagierbar tastenReagierbar) {
        if(tastenReagierbar instanceof Game) {
            Logger.error("ea.handle.Anmelden", "Der Eingabe-Parameter tastenReagierbar leitet sich von der Klasse Game ab. Das würde für einen"
