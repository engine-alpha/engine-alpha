 ...
 * kehrt die Figur in ihren <b>Zustand</b> zurueck.<br /><br />
 * <b>WICHTIG</b>:<br />
...
extends Raum {
    ...
    static {
        ...
        Manager.standard.anmelden(new Ticker() {
            ...
            public void tick() {
                ...
                } catch(java.util.ConcurrentModificationException e) {}catch(NullPointerException npe) {}
            }
        }, 1);
    }
     ...
     * @param zustand1      Der erste Zustand der Figur. Weitere Zustaende koennen ueber die Methode
     * <code>neuerZustand</code> angemeldet werden.
     * @param zustandsName1 Der name des ersten Zustandes. Weitere Zustaende koennen ueber die Methode
     * <code>neuerZustand</code> angemeldet werden.
     */
     ...
     * @param zustandFigur  Die Figur, die diesen Zustand beschreibt.
     * @param name          Der Name, unter dem dieser Zustand aufgerufen wird.
     ...
     * @param aktionsFigur  Die Figur, die diese Aktion beschreibt.
     * @param name          Der Name, unter dem diese Aktion aufgerufen wird.
     ...
     * danach sichtbar.
     * @param name  Der Name des Zustandes, in den die Figur versetzt werden soll.
    ...
    public void zustandSetzen(String name) {
        ...
        System.err.println("Achtung! Der Name des auszufuehrenden Zustandes wurde nie bei einer Anmeldung mitgegeben! " +
                "Der Name, der nicht unter den Zustaenden gefunden wurde war: " + name);
    }

    /**
     * Versetzt diese <i>Actionfigur</i> in eine bestimmte Aktion.
     * @param name  Der Name der Aktion, die die Figur ausfuehren soll.
    ...
    public void aktionSetzen(String name) {
        ...
        System.err.println("Achtung! Der Name der auszufuehrenden Aktion wurde nie bei einer Anmeldung mitgegeben! " +
     ...
     * @param action    Ob diese Figur gerade eine Aktion ausfuehrt.
     */
    ...
    /**
     * Spiegelt <b>ALLE Figuren der <i>Zustaende</i> und <i>Aktionen</i></b> dieser Figur an der X-Achse. <br /><br />
     * <b>ACHTUNG!!!!</b><br />
     ...
     * sollten also alle aus derselben Anzahl an "Unterquadraten" (gleiche hoehe * breite) bestehen!</i><br /><br />
     * Ansonsten wuerde ein ungewolltes "Verschieben" der verschiedenen Action-Figur-Verhalten passieren.
     * @param spiegel   Ob alle angelegten Figuren (der <i>Zustaende</i> und <i>Aktionen</i>) an der X-Achse gespiegelt
     * werden sollen.
    ...
    /**
     * Spiegelt <b>ALLE Figuren der <i>Zustaende</i> und <i>Aktionen</i></b> dieser Figur an der Y-Achse. <br /><br />
     * <b>ACHTUNG!!!!</b><br />
     * Damit diese Methode <b>nicht zu ungewollten Missverstaendnissen</b> fuehrt, sollte folgendes beachtet werden:<br />
     * <i>Saemtliche einzelnen Figuren, die an dieser Action-Figur angemeldet sind, sollten <b>dieselben Masse haben</b>. Sie
     * sollten also alle aus derselben Anzahl an "Unterquadraten" (gleiche hoehe * breite) bestehen!</i><br /><br />
     * Ansonsten wuerde ein ungewolltes "Verschieben" der verschiedenen Action-Figur-Verhalten passieren.
     * @param spiegel   Ob alle angelegten Figuren (der <i>Zustaende</i> und <i>Aktionen</i>) an der Y-Achse gespiegelt
     * werden sollen.
     ...
     * @param f Die Farbe, die alle Felder aller Figuren annehmen werden.
     * @see Figur.einfaerben( ea.graphic.Farbe )
    ...
    /**
     * Faerbt <b>alle</b> Figuren dieser Action-Figur in eine Farbe ein.
     * @param farbe Die Farbe, die alle Felder aller Figuren annehmen werden. Als Standardfarben-String.
     ...
     * @see ea.graphic.figures.Figur.faktorSetzen(int)
     */
     ...
     * @param v Die Verschiebung als Objekt der Klasse <code>Vektor</code>
     */
    @Override
