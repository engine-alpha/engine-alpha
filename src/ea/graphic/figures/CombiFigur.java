...
extends Raum {
     ...
     * @param figur1    Die erste Figur.
     * @param name1     Der Name der ersten Figur.
     */
     ...
     * @param figur Die hinzuzufuegende Figur selbst.
     * @param name  Der Name, unter dem diese Figur ab dann zu erreichen ist.
     */
     ...
     * @param name  Der Name der zu suchenden Figur.
    ...
    public ActionFigur get(String name) {
        ...
        System.err.println("Achtung! Der Eingegebene Name eines Gliedes dieser " +
                "CombiFigur existiert nicht: " + name);
        return null;
    }
    ...
    public BoundingRechteck dimension() {
        ...
        for(int i = 1; i < figuren.length; i++) {
            dim = dim.summe(figuren[i].dimension());
        }
        return dim;
    }
