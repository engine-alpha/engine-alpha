...
implements Leuchtend, Listung
{
     ...
     * @param   anzahlFormen    Die Anzahl der Dreiecke, aus denen die Form bestehen wird.
     ...
     * @param   r   Ein beliebiges anderes grafisches Objekt
     ...
     * Setzt ganzheitlich die Farbe aller Formen auf eine bestimmte Farbe.<br />
     * Dadurch faerbt sich im Endeffekt das ganze Objekt neu ein.
     * @param   farbe   Der String-Wert der Farbe. Zu der Zuordnung siehe <b>Handbuch</b>
     */
     ...
     * @param   leuchtet    Ob dieses Objekt nun leuchten soll oder nicht (mehr).
     */
    @Override
