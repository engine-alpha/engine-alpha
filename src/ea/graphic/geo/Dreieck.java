...
extends Geometrie
{
     ...
     * @param c Die Farbe dieses Dreiecks, anhand der Klasse <code>Color</code>.
     */
     ...
     * @param x Die Koordinaten aller X-Punkte. Der Index gibt den Punkt an (x[0] und y[0] bilden einen Punkt)
     * @param y Die Koordinaten aller Y-Punkte. Der Index gibt den Punkt an (x[0] und y[0] bilden einen Punkt)
     */
     ...
     * @param v Die Verschiebung als Vektor
     * @see Raum.verschieben( ea.graphic.Vektor )
     */
    @Override
    ...
    /**
     * Zeichnet das Objekt.
     * @param   g   Das zutaendige Graphics-Objekt
     * @param   r   Das BoundingRechteck, das das Kamerabild beschreibt.
     */
    @Override
